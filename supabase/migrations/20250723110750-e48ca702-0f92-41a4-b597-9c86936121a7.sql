...
CREATE TABLE public.menu_items (
  ...
  image_url TEXT,
  ingredients TEXT[] NOT NULL DEFAULT '{}', -- Array of ingredient IDs
...
CREATE POLICY "Admin users can manage ingredients" 
ON public.ingredients 
FOR ALL 
USING (
  EXISTS (
...
CREATE POLICY "Admin users can manage menu items" 
ON public.menu_items 
